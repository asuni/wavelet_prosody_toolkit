...
cwt_analysis_synthesis -v samples/01l_fact_0001.wav 01l_fact_0001.cwt
...
prosody_labeller -v -o test_libri -c wavelet_prosody_toolkit/configs/libritts.yaml samples/libritts
